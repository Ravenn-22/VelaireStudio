...
const services = [
  {
    ...
    desc: "One-of-a-kind pieces designed around your body, personality and vision.",
    size: "tall",
  },
  {
    id: 2,
    ...
    desc: "Every stitch placed with intention.",
    size: "normal",
  },
  {
    id: 3,
    ...
    desc: "Crafted for the moments that matter most.",
    size: "wide",
  },
  {
    id: 4,
    ...
    desc: "Precise alterations that feel like the garment was always yours.",
    size: "wide",
  },
  {
    id: 5,
    ...
    desc: "A curated eye on your wardrobe. Styling sessions that define your aesthetic.",
    size: "normal",
  },
  {
    id: 6,
    ...
    desc: "Clarity for your closet. A full audit of what you own and what you need.",
    size: "normal",
  },
  {
    id: 7,
    ...
    desc: "Workwear that carries your brand identity.",
    size: "normal",
  },
  {
    id: 8,
    type: "image",
    img: img3,
    name: "Fashion Collection Development",
    desc: "From concept to finished collection. Full creative support for designers ready to launch.",
    size: "wide",
  },
];
      ...
      <div className="bento-grid">
        {services.map((s) => (
          ...
          >
            ...
            <div
              className={`bento-content ${s.bg === "#f5f0e8" || s.bg === "#c9a99a" || s.bg === "#8a9e8a" ? "dark-text" : ""}`}
            >
