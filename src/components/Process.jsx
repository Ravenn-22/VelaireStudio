...
const steps = [
  {
    id: "01",
    name: "Consultation",
    desc: "Your vision, your story. This is where everything begins.",
  },
  {
    id: "02",
    name: "Design",
    desc: "Sketches tailored to you. Every detail considered.",
  },
  {
    id: "03",
    name: "Fabric Selection",
    desc: "Handpicked fabrics chosen for texture, drape and longevity.",
  },
  {
    id: "04",
    name: "Measurements",
    desc: "Precise measurements built for your body and no one else's.",
  },
  {
    id: "05",
    name: "Creation & Fitting",
    desc: "The garment comes to life through careful fitting sessions.",
  },
  {
    id: "06",
    name: "Delivery",
    desc: "Your finished piece, delivered with care and intention.",
  },
];
