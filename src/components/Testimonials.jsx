...
const testimonials = [
  {
    ...
    img: img1,
    quote:
      "The attention to detail was exceptional. My dress fit perfectly and made me feel confident throughout my event.",
    position: "top-left",
  },
  {
    id: 2,
    ...
    img: img2,
    quote:
      "From consultation to delivery, the experience was seamless. The final outfit exceeded my expectations.",
    position: "top-right",
  },
  {
    id: 3,
    ...
    img: img3,
    quote:
      "She truly understood my vision and transformed it into something even more beautiful than I imagined.",
    position: "mid-left",
  },
  {
    id: 4,
    ...
    img: img4,
    quote:
      "Professional, creative, and reliable. The craftsmanship was outstanding and delivered right on schedule.",
    position: "mid-right",
  },
  {
    id: 5,
    ...
    img: img5,
    quote:
      "Every stitch reflected excellence. Elegant, unique, and perfectly tailored to my personality.",
  ...
  },
  {
    ...
    img: img6,
    quote:
      "Clear communication, precise fittings, and a stunning final result. A truly wonderful experience.",
